...
type ResetStatusType = ResetStatus[keyof ResetStatus];
...
const LoginPage: React.FC = () => {
  ...
  const [resetStatus, setResetStatus] = useState<ResetStatusType>('idle');
  ...
  const handleResetKeyDown = (e: React.KeyboardEvent<HTMLInputElement>): void => {
